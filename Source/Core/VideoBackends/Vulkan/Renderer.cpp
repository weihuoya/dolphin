...
{
  return static_cast<u16>(static_cast<u32>(m_bounding_box->Get(static_cast<size_t>(index))));
}

void Renderer::BBoxWrite(int index, u16 value)
{
  m_bounding_box->Set(static_cast<size_t>(index), static_cast<s32>(static_cast<u32>(value)));
}
